  ...
  return (
    <div className="space-y-10 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {metrics.map((m, i) => (
          <div key={i} className="google-border-animated card-premium metric-card relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="google-border-animated lg:col-span-2 card-premium p-8">
        ...
        <div className="google-border-animated card-premium p-8 bg-black/5 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-2">
